...
const rules: KarabinerRules[] = [
  ...
  ...createHyperSubLayers({
    ...
    // Raycast
    q: {
      equal_sign: open('raycast://extensions/mooxl/coffee/caffeinate?launchType=background'),
      hyphen: open('raycast://extensions/mooxl/coffee/decaffeinate?launchType=background'),
